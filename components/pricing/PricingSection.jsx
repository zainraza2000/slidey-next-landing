...
const PricingSection = () => {
  ...
  return (
    <section className=" bg-pricing xl:w-4/5 md:w-[90%] w-full md:px-0 px-5 flex flex-col justify-between md:gap-5 xl:gap-8 mx-auto md:py-28 py-20">
        ...
        {pricingData.map((item, i) => (
          <div
            ...
            className={` bg-white flex-1 md:rounded-[40px] rounded-xl ${
              item.id === 2
                ? "2xl:h-[858px] xl:h-[750px] md:h-[640px] h-[300px]"
                : "2xl:h-[770px] xl:h-[690px] md:h-[580px] h-[280px]"
          ...
          >
            <div
              ...
              } w-full md:rounded-[30px] rounded-lg xl:h-64 md:px-6 px-2`}
            >
              <span className=" fontGivonic 2xl:text-4xl xl:text-4xl md:text-[32px] text-xs text-white font-semibold tracking-wider">
                #0{item.id}
              </span>
              <h3 className=" fontGivonic 2xl:text-5xl xl:text-4xl md:text-[32px] text-xs text-white font-semibold xl:tracking-wide md:tracking-wider">
                {item.heading}
              </h3>
            </div>
            <h3
