...
// IMAGES
import heroSectionCardImg1 from "@/assets/images/herosection/herosection-card-1.webp";
import heroSectionModalImg1 from "@/assets/images/herosection/herosection-modal-1.webp";
import heroSectionCardImg2 from "@/assets/images/herosection/herosection-card-2.webp";
import heroSectionModalImg2 from "@/assets/images/herosection/herosection-modal-2.webp";
import heroSectionCardImg3 from "@/assets/images/herosection/herosection-card-3.webp";
import heroSectionModalImg3 from "@/assets/images/herosection/herosection-modal-3.webp";
import heroSectionCardImg4 from "@/assets/images/herosection/herosection-card-4.webp";
import heroSectionCardImg5 from "@/assets/images/herosection/herosection-card-5.webp";
import heroSectionCardImg6 from "@/assets/images/herosection/herosection-card-6.webp";
import slideyLogo from "@/assets/images/logo-white.png";
import exploreImg from "@/assets/images/explore-img.webp";
import bdDownImg from "@/assets/images/bg-down-4.png";
import mainBg from "@/assets/images/Vector.webp";
        ...
        <div className=" text-white z-50 md:w-5/6 w-[90%] md:pt-8 pt-4">
          ...
          <div className=" flex justify-between 2xl:mt-20 xl:mt-14 md:mt-6 mt-4">
            <div className=" flex flex-col 2xl:gap-3 md:gap-1 gap-0">
              <h2 className="  2xl:text-5xl md:text-[32px] text-[13px] font-semibold">
                5K+
              </h2>
