      ...
      <div className="relative flex justify-center 2xl:h-[950px] xl:h-[650px] md:h-[630px] h-[720px] w-full 2xl:pt-11 xl:pt-8 md:pt-6 pt-4 2xl:px-20 xl:px-16 md:px-8 px-6">
        ...
        <div className=" text-white z-50 md:w-5/6 w-[90%] md:pt-8 pt-4">
          ...
          <div className=" fontGivonic flex justify-between 2xl:mt-20 xl:mt-14 md:mt-10 mt-4">
            <h1 className=" md:w-[40%] w-[50%] 2xl:text-6xl xl:text-[30px] md:text-[24px] text-sm font-semibold tracking-wider 2xl:leading-tight xl:leading-snug md:leading-tight">
          ...
          <div className=" flex justify-between 2xl:mt-20 xl:mt-14 md:mt-6 mt-4">
            <div className=" flex flex-col 2xl:gap-3 md:gap-1 gap-0">
              <h3 className=" fontAntapani 2xl:text-5xl md:text-[32px] text-[13px] font-semibold">
                5K+
              </h3>
            ...
            {currentCards === 1 && (
              <>
                <motion.li
                  ...
                  className="absolute 
                  2xl:top-[75px] 2xl:hover:top-[110px] 2xl:left-16 2xl:hover:left-16 bg-lime-700 2xl:w-[270px] 2xl:h-[380px]
                ...
                <motion.li
                  variants={cardsVariants}
                  className="absolute 
                  2xl:top-8 2xl:hover:top-[38px] bg-orange-400 2xl:w-[300px] 2xl:h-[440px] 2xl:hover:w-[320px] 2xl:hover:h-[480px]
                ...
                <motion.li
                  variants={cardsVariants}
                  className="absolute 
                  2xl:top-[75px] 2xl:hover:top-[105px] 2xl:right-12 2xl:hover:right-10 bg-stone-600 2xl:w-[280px] 2xl:h-[380px]  2xl:hover:h-[435px]
